...
import { GraduationCap, BookOpen, Users, FileText, ArrowLeft, Calendar, Megaphone, Folder, Layers, Book } from "lucide-react"
...
export default function CourseDetailPage() {
  ...
  return (
    <div className="flex gap-6 h-full">
      {/* Sidebar */}
      <nav className="flex w-48 shrink-0 flex-col border-r border-border py-2 self-stretch">
        {[
      ...
      <div className="flex-1 space-y-6">
          ...
          <div className="space-y-5 px-6 pt-9 pb-5">
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-1 text-xs text-muted-foreground">
              ...
              <span className="flex items-center gap-1.5">
                ...
                {course.semester === "1st" ? "First Semester" : course.semester === "2nd" ? "Second Semester" : "Summer"}
              </span>
              {course.lastActivity && (
                <span className="flex items-center gap-1.5">
                  <Calendar className="size-3.5" />
        ...
        <div>
          {activeTab === "announcements" && (
            <p className="text-sm text-muted-foreground">Announcements coming soon.</p>
          )}
          {activeTab === "sections" && (
